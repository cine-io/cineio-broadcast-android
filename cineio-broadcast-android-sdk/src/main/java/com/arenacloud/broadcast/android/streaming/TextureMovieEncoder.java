...
import com.arenacloud.broadcast.android.streaming.gles.EglCore;
...
import com.arenacloud.broadcast.android.streaming.gles.WindowSurface;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private void prepareEncoder(EGLContext sharedContext, Muxer muxer) {
        try {
            mVideoEncoder = new VideoEncoderCore(muxer);
...
//We need to access the encoderHandler, for instance to capture frames
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(Muxer muxer, EGLContext sharedEglContext) {
            mMuxer = muxer;
        ...
        public String toString() {
            return mMuxer.toString() + "' ctxt=" + mEglContext;
        }
    }
